...
const routes: Routes = [
  ...
  { path: 'auth/complete', component: AuthCompleteComponent, canActivate: [AuthGuard] },
  { path: 'forgot-password', component: ForgotPasswordComponent },
  { path: 'reset-password/:token', component: ResetPasswordComponent },
  { path: 'apartment-create', component: ApartmentCreateComponent, canActivate: [AuthGuard] },
];
